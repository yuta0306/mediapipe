    ...
    def _generate_proto(self, source):
        ...
        if not os.path.exists(output):
            ...
            protoc_command = [
                ...
                source,
                "--experimental_allow_proto3_optional",  # Add for avoiding `This file contains proto3 optional fields, but --experimental_allow_proto3_optional was not set.`
            ]
