...
_SHORT_RANGE_GRAPH_FILE_PATH = (
    "mediapipe/modules/face_detection/face_detection_short_range_gpu.binarypb"
)
_FULL_RANGE_GRAPH_FILE_PATH = (
    "mediapipe/modules/face_detection/face_detection_full_range_gpu.binarypb"
)
...
class FaceDetection(SolutionBase):
    ...
    def __init__(self, min_detection_confidence=0.5, model_selection=0):
        ...
        binary_graph_path = (
            ...
            else _SHORT_RANGE_GRAPH_FILE_PATH
        )
