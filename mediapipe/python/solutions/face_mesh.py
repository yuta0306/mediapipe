...
class FaceMesh(SolutionBase):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            calculator_params={
                "facedetectionshortrangegpu__facedetectionshortrange__facedetection__TensorsToDetectionsCalculator.min_score_thresh": min_detection_confidence,
                "facelandmarkgpu__ThresholdingCalculator.threshold": min_tracking_confidence,
            },
