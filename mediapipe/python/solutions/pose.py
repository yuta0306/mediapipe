...
class Pose(SolutionBase):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            calculator_params={
                "posedetectioncpu__TensorsToDetectionsCalculator.min_score_thresh": min_detection_confidence,
                "poselandmarkbyroicpu__tensorstoposelandmarksandsegmentation__ThresholdingCalculator.threshold": min_tracking_confidence,
            },
