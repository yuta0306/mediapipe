...
class Hands(SolutionBase):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            calculator_params={
                "palmdetectioncpu__TensorsToDetectionsCalculator.min_score_thresh": min_detection_confidence,
                "handlandmarkcpu__ThresholdingCalculator.threshold": min_tracking_confidence,
            },
            outputs=[
