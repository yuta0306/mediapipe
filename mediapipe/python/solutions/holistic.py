...
class Holistic(SolutionBase):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            calculator_params={
                "poselandmarkcpu__posedetectioncpu__TensorsToDetectionsCalculator.min_score_thresh": min_detection_confidence,
                "poselandmarkcpu__poselandmarkbyroicpu__tensorstoposelandmarksandsegmentation__ThresholdingCalculator.threshold": min_tracking_confidence,
            },
            outputs=[
                "pose_landmarks",
    ...
    def process(self, image: np.ndarray) -> NamedTuple:
        ...
        if results.pose_landmarks:  # pytype: disable=attribute-error
            for (
                landmark
            ) in results.pose_landmarks.landmark:  # pytype: disable=attribute-error
